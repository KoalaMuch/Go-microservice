...
func (l *LogEntry) Insert(entry LogEntry) error {
	...
	if err != nil {
		log.Printf("Error inserting log entry: \n", err)
		return err
	}
	return nil
}
...
func (l *LogEntry) All() ([]*LogEntry, error) {
	...
	if err != nil {
		log.Printf("Error finding all logs error: \n", err)
		return nil, err
	}
	...
	for cursor.Next(ctx) {
		...
		if err != nil {
			log.Println("Error decoding log item: ", err)
			return nil, err
		}
...
func (l *LogEntry) Update() (*mongo.UpdateResult, error) {
	...
	result, err := collection.UpdateOne(
		...
		bson.M{"_id": docId},
		bson.D{
			{"$set", bson.D{{"name", l.Name}, {"data", l.Data}, {"updated_at", time.Now()}}},
		},
	)
	if err != nil {
